...
logger = logging.getLogger('deployment_logi')
...
def get_dataset2(name):
    ...
    if name=='Quantile Res':
        ...
        # st.write('Partial_Plots',Diagnostics.Partial_Plots(GLM_Bino.GLM_Binomial_fit, train_test.X_test\
        #     ,train_test.Y_test, train_test.X_train, train_test.Y_train, threshold=0.47))
